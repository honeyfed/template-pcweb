  ...
  <div id="haina-header">
    <el-row class="haina-header__wrapper">
      ...
      <el-col :span="18">
        ...
        <div class="header_modules">网格联动平台</div>
      </el-col>
      <el-col :span="3">
        <div class="header_info">
          <div id="user-box" v-if="showUserInfo">
            ...
            <div class="user-info">
              <div class="company-name">{{ userInfo.CorpName }}</div>
                ...
                >
                  <div class="user-box-ll">
                    ...
                    <div class="el-dropdown-link user-name">
                      <div class="user-name-box">{{ userInfo.UserName }}</div>
...
<script>
import logo from './assets/haina_logo_white.png';
export default {
  ...
  methods: {
    handleMenu(command) {
      ...
      this.$emit('on-menu-licked', command);
    },
  },
};
</script>
